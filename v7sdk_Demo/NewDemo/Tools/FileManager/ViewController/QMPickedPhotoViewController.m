...
- (void)viewDidLoad {
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, QM_kScreenWidth, QM_kScreenHeight - 44) collectionViewLayout:layout];
    ...
    _tabbarView.frame = CGRectMake(0, QM_kScreenHeight - 44, QM_kScreenWidth, 44);
