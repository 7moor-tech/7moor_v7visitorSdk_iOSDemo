...
- (void)viewDidLoad {
    ...
    [button setTitle:@"返回".toLocalized forState:UIControlStateNormal];
    ...
    if (self.isForm) {
        NSString *encodedString = [self.filePath stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]];
